    ...
    return (
        <div className="flex flex-col w-full">
            <div className="flex gap-3 my-14 dark-text-color max-h-[60px]">
                ...
                {/* Source Code Button (Navigates to Portfolio Github Repo) @ Large Screen */}
                <div className={`${isDarkMode ? 'bg-neutral-600' : 'bg-white'} expand-hover cursor-pointer rounded-2xl lg:rounded-full md:flex hidden items-center justify-center px-6 w-1/5`}>
                ...
                <div className="flex flex-col md:flex-row gap-3 w-full">
                    ...
                    {/* Source Code Button (Navigates to Portfolio Github Repo) @ Small Screen */}
